- dashboard: business_summary_2022_v3
  ...
  - title: Monthly Attributed Share of Project Revenue L12M
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: Alaric Jewitt - project_attribution.attributed_revenue_gbp,
            id: Alaric Jewitt - project_attribution.attributed_revenue_gbp, name: Alaric
              Jewitt}, {axisId: Amir Jaber - project_attribution.attributed_revenue_gbp,
            id: Amir Jaber - project_attribution.attributed_revenue_gbp, name: Amir
              Jaber}, {axisId: Asif Ashraf - project_attribution.attributed_revenue_gbp,
            id: Asif Ashraf - project_attribution.attributed_revenue_gbp, name: Asif
              Ashraf}, {axisId: Carlo Behtash - project_attribution.attributed_revenue_gbp,
            id: Carlo Behtash - project_attribution.attributed_revenue_gbp, name: Carlo
              Behtash}, {axisId: David Murray - project_attribution.attributed_revenue_gbp,
            id: David Murray - project_attribution.attributed_revenue_gbp, name: David
              Murray}, {axisId: George Sanderson - project_attribution.attributed_revenue_gbp,
            id: George Sanderson - project_attribution.attributed_revenue_gbp, name: George
              Sanderson}, {axisId: Giuseppe Mento - project_attribution.attributed_revenue_gbp,
            id: Giuseppe Mento - project_attribution.attributed_revenue_gbp, name: Giuseppe
              Mento}, {axisId: Jordan Ilyat - project_attribution.attributed_revenue_gbp,
            id: Jordan Ilyat - project_attribution.attributed_revenue_gbp, name: Jordan
              Ilyat}, {axisId: Lewis Baker - project_attribution.attributed_revenue_gbp,
            id: Lewis Baker - project_attribution.attributed_revenue_gbp, name: Lewis
              Baker}, {axisId: Mark Rittman - project_attribution.attributed_revenue_gbp,
            id: Mark Rittman - project_attribution.attributed_revenue_gbp, name: Mark
              Rittman}, {axisId: Mike Calleja - project_attribution.attributed_revenue_gbp,
            id: Mike Calleja - project_attribution.attributed_revenue_gbp, name: Mike
              Calleja}, {axisId: Olivier Dupuis - project_attribution.attributed_revenue_gbp,
            id: Olivier Dupuis - project_attribution.attributed_revenue_gbp, name: Olivier
              Dupuis}, {axisId: Rob Bramwell - project_attribution.attributed_revenue_gbp,
            id: Rob Bramwell - project_attribution.attributed_revenue_gbp, name: Rob
              Bramwell}, {axisId: Will Berrystone - project_attribution.attributed_revenue_gbp,
            id: Will Berrystone - project_attribution.attributed_revenue_gbp, name: Will
              Berrystone}, {axisId: Younes Chahid - project_attribution.attributed_revenue_gbp,
            id: Younes Chahid - project_attribution.attributed_revenue_gbp, name: Younes
              Chahid}], showLabels: true, showValues: true, valueFormat: '"£"0,"K"',
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear}]
    hidden_series: []
    hide_legend: true
    defaults_version: 1
  ...
  - name: Financial Scorecard
    ...
    note_display: hover
    note_text: Closed Deals vs. Target (50% Weighting) + Net Revenue to Target (50%)
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    custom_color_enabled: true
    show_single_value_title: true
    single_value_title: Financial LM
    ...
    conditional_formatting_include_nulls: false
    font_size_main: '40'
    style_financial: "#3C358B"
    show_title_financial: true
    title_placement_financial: above
    value_format_financial: 0%
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
  ...
  - name: Customer Scorecard
    ...
    note_state: collapsed
    note_display: hover
    note_text: On-Time Delivery vs. Target (100%)
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    hidden_fields: [contact_utilization_fact.total_forecast_billable_hours, contact_utilization_fact.total_actual_billable_hours,
      contact_utilization_fact.total_target_billable_capacity, contact_utilization_fact.total_total_capacity,
      actual_utilization, forecast_utilization, projects_delivered_is_ontime.count_ontime_timesheet_projects,
      projects_delivered.count_timesheet_projects, targets.avg_hr_survey_target, targets.total_revenue_target,
      targets.avg_enps_target, projects_invoiced.total_net_amount_gbp, hr_survey_results_fact.avg_e_nps,
      certification_progress.total_score, certification_progress.score_target, target_utilization,
      deals_fact.total_deal_amount_gbp_converted, targets.total_deals_closed_target,
      target_of_projects_ontime, new_deals_pct_to_target, revenue_pct_to_target, pct_of_projects_ontime_to_target,
      pct_certification_progression_to_target, pct_of_utilization_to_target, pct_enps_to_target,
      financial, process_customer_perspective_weighted_30]
    type: single_value
    query_fields:
      measures:
      - align: right
  ...
  - name: Process Perspective
    title: Process Perspective
    note_state: collapsed
    note_display: hover
    note_text: Actual Utilisation % vs Target % (100%)
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    hidden_fields: [contact_utilization_fact.total_forecast_billable_hours, contact_utilization_fact.total_actual_billable_hours,
      contact_utilization_fact.total_target_billable_capacity, contact_utilization_fact.total_total_capacity,
      actual_utilization, forecast_utilization, projects_delivered.count_timesheet_projects,
      targets.avg_hr_survey_target, targets.total_revenue_target, targets.avg_enps_target,
      projects_invoiced.total_net_amount_gbp, hr_survey_results_fact.avg_e_nps, certification_progress.total_score,
      certification_progress.score_target, target_utilization, deals_fact.total_deal_amount_gbp_converted,
    ...
    width: 4
    height: 3
  - name: Innovation Perspective
    title: Innovation Perspective
    note_state: collapsed
    note_display: hover
    note_text: Certification Progress % to Target % (50%) + Team eNPS vs Target (50%)
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    custom_color_enabled: true
    show_single_value_title: true
    single_value_title: Innovation LM
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
    ...
    conditional_formatting: [{type: between, value: [0.7, 1], background_color: "#E48522",
        ...
        font_color: "#FFFFFF", color_application: {collection_id: da8306b5-3b46-48aa-9ead-a3b32292f35c,
          palette_id: 00fb21bc-5a8c-46b1-88bf-2a6a3d102830}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}, {type: greater than, value: 1, background_color: "#C4DF58",
        font_color: "#FFFFFF", color_application: {collection_id: da8306b5-3b46-48aa-9ead-a3b32292f35c,
          palette_id: 00fb21bc-5a8c-46b1-88bf-2a6a3d102830}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}]
    conditional_formatting_include_totals: false
    ...
    hidden_fields: [contact_utilization_fact.total_forecast_billable_hours, contact_utilization_fact.total_actual_billable_hours,
      ...
      revenue_pct_to_target, pct_of_projects_ontime_to_target, pct_certification_progression_to_target,
      pct_enps_to_target, financial, process_customer_perspective_weighted_30, projects_delivered_is_ontime.count_ontime_timesheet_projects,
      of_projects_ontime, process_perspective, customer_perspective, pct_of_utilization_to_target]
    type: single_value
    query_fields:
      measures:
      - align: right
    ...
    width: 4
    height: 3
  - name: Scorecard Perspectives L12M
    title: Scorecard Perspectives L12M
    note_state: collapsed
    note_display: hover
    note_text: Unweighted % for each perspective, over time.
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    series_colors:
      innovation_learning_perspective_weighted_20: "#E48522"
      weighted_overall_score: "#0d0305"
      process_perspective: "#D13452"
    series_labels:
      financial_weighted_50: Finance % (50% of Overall)
      process_customer_perspective_weighted_30: Process % (30% of Overall)
      innovation_learning_perspective_weighted_20: Learning % (20% of Overall)
    ...
    enable_conditional_formatting: true
    conditional_formatting: [{type: between, value: [0.7, 1], background_color: "#E48522",
        font_color: '', color_application: {collection_id: da8306b5-3b46-48aa-9ead-a3b32292f35c,
          palette_id: 00fb21bc-5a8c-46b1-88bf-2a6a3d102830}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}, {type: less than, value: 0.7, background_color: "#D13452",
        font_color: '', color_application: {collection_id: da8306b5-3b46-48aa-9ead-a3b32292f35c,
          palette_id: 00fb21bc-5a8c-46b1-88bf-2a6a3d102830}, bold: false, italic: false,
    ...
    hidden_fields: [contact_utilization_fact.total_forecast_billable_hours, contact_utilization_fact.total_actual_billable_hours,
      ...
      revenue_pct_to_target, pct_of_projects_ontime_to_target, pct_certification_progression_to_target,
      pct_enps_to_target, financial, process_customer_perspective_weighted_30, projects_delivered_is_ontime.count_ontime_timesheet_projects,
      of_projects_ontime, pct_of_utilization_to_target]
    type: looker_line
    query_fields:
      measures:
      - align: right
    ...
    dynamic_fields: [{category: table_calculation, expression: 'coalesce(${deals_fact.total_deal_amount_gbp_converted}/${targets.total_deals_closed_target},0)',
      ...
      {category: table_calculation, expression: "${certification_progress.total_score}/${certification_progress.score_target}",
        ...
        _kind_hint: measure, table_calculation: pct_certification_progression_to_target,
        _type_hint: number}, {category: table_calculation, expression: "((${new_deals_pct_to_target}*0.5)+(${revenue_pct_to_target}*0.5))",
        label: Financial Perspective, value_format: !!null '', value_format_name: percent_0,
        _kind_hint: measure, table_calculation: financial_perspective, _type_hint: number},
      {category: table_calculation, description: Based on % of Projects Delivered
          On-Time, expression: "((${pct_of_projects_ontime_to_target}))", label: Customer
          Perspective, value_format: !!null '', value_format_name: percent_0, _kind_hint: measure,
        table_calculation: customer_perspective, _type_hint: number}, {category: table_calculation,
        expression: "((${pct_enps_to_target}*0.5)+(${pct_certification_progression_to_target}*0.5)*1)",
        label: Innovation & Learning Perspective, value_format: !!null '', value_format_name: percent_0,
        _kind_hint: measure, table_calculation: innovation_learning_perspective, _type_hint: number},
      {category: table_calculation, description: Based on actual utilization %, expression: "${pct_of_utilization_to_target}",
      ...
      {category: table_calculation, expression: "(${financial_perspective}*0.5)+(${customer_perspective}*0.2)+(coalesce(${innovation_learning_perspective},0)*0.2)+(${process_perspective}*0.1)",
        label: Weighted Overall Score, value_format: !!null '', value_format_name: percent_0,
        _kind_hint: measure, table_calculation: weighted_overall_score, _type_hint: number}]
    row: 3
    col: 8
    width: 12
    height: 6
  - name: Weighted Score
    ...
    note_state: collapsed
    note_display: hover
    note_text: Overall percentage = Financial Perspective (50%) + Customer Perspective
      (20%) + Process Perspectives (20%) + Innovation Perspective (10%)
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
      type: table
    ...
    custom_color: "#FFFFFF"
    show_single_value_title: true
    single_value_title: Weighted Score LM
    value_format: ''
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    ...
    hidden_fields: [contact_utilization_fact.total_forecast_billable_hours, contact_utilization_fact.total_actual_billable_hours,
      ...
      revenue_pct_to_target, pct_of_projects_ontime_to_target, pct_certification_progression_to_target,
      pct_enps_to_target, financial, process_customer_perspective_weighted_30, projects_delivered_is_ontime.count_ontime_timesheet_projects,
      of_projects_ontime, pct_of_utilization_to_target, process_perspective, innovation_learning_perspective,
      customer_perspective, financial_perspective]
    type: single_value
    query_fields:
      measures:
      - align: right
    ...
    width: 4
    height: 4
  - name: Weighted Score (Copy)
    title: Weighted Score (Copy)
    title_hidden: true
    merged_queries:
    - model: analytics
      explore: contact_utilization_fact
    ...
    y_axis_gridlines: true
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{axisId: weighted_overall_score,
            id: weighted_overall_score, name: Weighted Overall Score}], showLabels: false,
        showValues: false, maxValue: 2, unpinAxis: false, tickDensity: default, tickDensityCustom: 5,
        type: linear}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - name: " (6)"
    type: text
    title_text: ''
    subtitle_text: Balanced Scorecard
    body_text: ''
    row: 2
    col: 0
    width: 24
