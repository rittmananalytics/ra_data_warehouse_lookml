...
- dashboard: business_summary
  ...
  - title: Individual Utilisation
    ...
    filters:
      contacts.contact_is_staff: ''
      contacts.contact_name: Lewis Baker,Jordan Ilyat,Lydia Blackley,Bailey Sharpledger,Saverro
        Suseno,Olivier Dupuis,Erik Edelmann,Giuseppe Mento,Mark Rittman,Alexander
        Caldwell
  ...
  - title: Engagement RAG Status
    ...
    filters:
      ...
      timesheet_project_engagement_rag_status_fact.engagement_name: "-NULL"
  ...
  - title: What are the hourly rates for our booked + forecasted (deals with a start
    ...
    minimum_column_width: 75
    series_labels:
      monthly_resource_revenue_forecast_fact.engagement_name: Engagement
      monthly_resource_revenue_forecast_fact.avg_forecast_hourly_rate: Rate
      monthly_resource_revenue_forecast_fact.forecast_month: Month
    series_cell_visualizations:
  ...
  - title: NPS
    ...
    filters:
      nps_survey_results_fact.nps_survey_ts_date: 1 months
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
  ...
  - title: Consultant Hourly Rates
    ...
    minimum_column_width: 75
    series_labels:
      recognized_revenue_contact.contact_name: Name
  ...
  - name: What's the "Mood" on our Projects?
    ...
    width: 12
    height: 7
  - title: How much cash do we have in the bank, including provisions for tax?
    name: How much cash do we have in the bank, including provisions for tax?
    model: analytics
  ...
  - name: Over-Under Delivery vs Forecast
    ...
    - model: analytics
      explore: companies_dim
      type: table
      fields: [project_timesheet_users.contact_name, project_timesheets.total_timesheet_billable_hours_billed,
        project_timesheets.total_timesheet_nonbillable_hours_billed, project_timesheets.timesheet_billing_month,
        projects_delivered.project_name]
      sorts: [project_timesheets.timesheet_billing_month desc]
      limit: 500
      column_limit: 50
      join_fields:
      ...
      - field_name: projects_delivered.project_name
    ...
    width: 12
    height: 13
  - title: Forecast Weighted Pipeline (Booked + Weighted Open Deals)
    name: Forecast Weighted Pipeline (Booked + Weighted Open Deals)
    model: analytics
    explore: monthly_resource_revenue_forecast_fact
    type: looker_column
    fields: [monthly_resource_revenue_forecast_fact.forecast_month, monthly_resource_revenue_forecast_fact.dynamic_measure,
      monthly_resource_revenue_forecast_fact.dynamic_split]
    pivots: [monthly_resource_revenue_forecast_fact.dynamic_split]
    filters:
      monthly_resource_revenue_forecast_fact.forecast_month: after 0 months ago
      monthly_resource_revenue_forecast_fact.selected_measure: total^_forecast^_revenue^_gbp
      monthly_resource_revenue_forecast_fact.selected_split: forecast^_type
    sorts: [monthly_resource_revenue_forecast_fact.dynamic_split, monthly_resource_revenue_forecast_fact.forecast_month]
    limit: 500
    column_limit: 50
    total: true
    x_axis_gridlines: false
    ...
    label_value_format: '"£"0,"K"'
    series_colors:
      Pipeline - monthly_resource_revenue_forecast_fact.dynamic_measure: "#dbd9d4"
    show_null_points: true
    interpolation: linear
    show_row_numbers: true
    transpose: false
    ...
    minimum_column_width: 75
    series_cell_visualizations:
      monthly_resource_revenue_forecast_fact.total_weighted_forecast_monthly_hours:
        is_active: false
    hidden_pivots: {}
    defaults_version: 1
    hidden_fields: []
    ...
    width: 12
    height: 10
  - title: How has our revenue growth compared to the last 5 years?
    name: How has our revenue growth compared to the last 5 years?
    model: analytics
    explore: chart_of_accounts_dim
    type: looker_line
    fields: [profit_and_loss_report_fact.period_month_num, profit_and_loss_report_fact.period_year,
      revenue]
    pivots: [profit_and_loss_report_fact.period_year]
    fill_fields: [profit_and_loss_report_fact.period_year]
    filters:
      profit_and_loss_report_fact.period_year: 5 years
    sorts: [profit_and_loss_report_fact.period_year, profit_and_loss_report_fact.period_month_num]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: measure
    ...
    - category: table_calculation
      expression: |-
        if(is_null(${revenue}),null,
          if(${revenue}=0,null,running_total(${revenue})))
      label: Running total of  Revenue
      value_format:
      value_format_name: gbp_0
      _kind_hint: measure
      table_calculation: running_total_of_revenue
      _type_hint: number
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    ...
    color_application:
      collection_id: da8306b5-3b46-48aa-9ead-a3b32292f35c
      palette_id: d9abd293-3cd0-448c-9540-4a55690e4ce1
      options:
        steps: 5
    x_axis_zoom: true
    y_axis_zoom: true
    series_colors:
      2025 - running_total_of_revenue: "#D13452"
    hidden_fields: [revenue]
    hidden_pivots: {}
    defaults_version: 1
    listen: {}
    row: 26
