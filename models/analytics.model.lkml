...
explore: staff_weekly_engagement_fact {
  ...
  view_label:  "Weekly"
  description: "Staff engagement across week / day / event grain. Default grain is weekly; add Daily fields to drill to per-day rows for the same staff & week, and add Event Timeline fields to drill to the timestamp-ordered event stream within a chosen day."
