...
explore: companies_dim {
  ...
  join: timesheet_project_engagement_recognized_revenue {
    ...
    fields: [total_recognized_revenue_gbp,total_delivery_cost_gbp,total_expense_cost_gbp,total_delivery_labour_cost_gbp,hours_billed,recognized_margin_gbp,total_hours_billed,billing_month_month,engagement_month_number]
  ...
  join: timesheet_project_engagement_timesheets_projects_dim {
    ...
    view_label: "        Engagements (SoWs)"
    sql_on: ${timesheet_project_engagements_dim__projects.timesheet_project_pk} = ${timesheet_project_engagement_timesheets_projects_dim.timesheet_project_pk} ;;
    type: left_outer
    relationship: many_to_one
  }
