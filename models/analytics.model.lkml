...
explore: companies_dim {
  ...
  join: timesheet_project_engagement_recognized_revenue {
    ...
    fields: [total_recognized_revenue_gbp,total_delivery_cost_gbp,total_expense_cost_gbp,total_delivery_labour_cost_gbp,hours_billed,recognized_margin_gbp,total_hours_billed]
